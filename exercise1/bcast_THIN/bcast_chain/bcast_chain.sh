...
do
    ...
    command="mpirun -np $np --map-by ppr:1:core:PE=1 --bind-to core --mca coll_tuned_use_dynamic_rules true --mca coll_tuned_bcast_algorithm 2 ${src_path}osu_bcast -x 1000 -i 10000 -m 1:1 -f"
