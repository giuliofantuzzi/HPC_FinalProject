...
```{r}
bcast_default.df<- read.csv(file = "bcast_default_all.csv")
bcast_linear.df<- read.csv(file = "bcast_linear_all.csv")
bcast_chain.df<- read.csv(file = "bcast_chain_all.csv")
bcast_binarytree.df<- read.csv(file = "bcast_binarytree_all.csv")
```
...
- Regarding the jump when changing socket,
